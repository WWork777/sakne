                ...
                <div className="flex flex-col gap-6  pb-16 xl:pb-20">
                    ...
                    <div className="flex flex-row items-end lg:items-baseline gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            <a 
                            href="https://wa.me/89994316266?text=Здравствуйте!%20Понравился%20сайт,%20хочу%20похожий.%20Расскажите%20подробнее..."
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group bg-primary hover:bg-secondary rounded-full pl-8 p-1.5 transition-colors duration-300 cursor-pointer"
                            >
                            <div className="bg-white p-3 md:p-5 rounded-full">
                                ...
                                className="group-hover:rotate-90 transition-transform duration-300" // Анимация при наведении
                                >
                                <path 
