                            ...
                            {menuOpen === false ?
                                ...
                                >
                                    <div className="flex items-center justify-between pb-5 border-b border-secondary/15 dark:border-white/15">
                                        <p className="text-secondary dark:text-white">Меню</p>
                                    ...
                                    <div>
                                        <Link href="tel:+79994316266" className="text-secondary/60 dark:text-white/60 hover:text-secondary dark:hover:text-white">+7-999-431-62-66</Link>
                                        <Link href="mailto:pavel-sakne@yandex.ru"><h4>pavel-sakne@yandex.ru</h4></Link>
                                    </div>
                                </div>
                            }
                        </div>
