            ...
            <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
              ...
              <div className="flex flex-col gap-11">
                <div className="flex flex-col gap-5 ">
                  <h2 className="max-w-3xl">Отзывы наших клиентов</h2>
                  <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                    Опыт, подтверждённый клиентами. Решения, которые работают на
                    рост бизнеса.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-7">
              <div className="bg-primary p-4 lg:p-7 flex flex-col gap-32">
                ...
                <div className="flex items-center gap-4">
                  <Image
                    src={"/images/testimonial/tvoy3d.svg"}
                    alt="Image"
                    width={60}
                    height={60}
              ...
              <div className="xl:col-span-2 bg-secondary dark:bg-lightgray/10 p-4 lg:p-7 flex flex-col justify-between gap-14">
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-2.5">
                    <StarRating count={5.0} color="#FFFFFF" />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <Image
                      src={"/images/testimonial/ilumastorelogo.svg"}
                      alt="Image"
                      width={60}
                      height={60}
                      className="rounded-full"
              ...
              <div className="bg-white dark:bg-black/20 p-4 lg:p-7 flex flex-col justify-between gap-32">
                ...
                <div className="flex items-center gap-4">
                  <Image
                    src={"/images/testimonial/aval42.png"}
                    alt="Image"
                    width={60}
                    height={60}
                    className="rounded-full"
