// components/ItOutsourcingSection.tsx
"use client";
...
export default function ItOutsourcingSection() {
  const [itOutSource, setItOutSource] = useState<{
    data: ItOutSourceItem[];
  } | null>(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setItOutSource(data?.itOutSource || null);
      } catch (error) {
        console.error("Error fetching IT outsourcing data:", error);
      }
    };
    fetchData();
  }, []);
        ...
        <div className="flex flex-col gap-11">
          <div className="flex flex-col gap-5 ">
            ...
            <p className="max-w-2xl text-secondary/70 dark:text-white/70">
              ...
              IT-аутсорсингом. Сфокусируйтесь на бизнесе, а технические задачи
              доверьте нам. Экономия времени и ресурсов без потери качества.
            </p>
          </div>
        </div>
      </div>
      ...
      {itOutSource?.data && itOutSource.data.length > 0 && (
        <div className="slider-container">
          <Slider {...sliderSettings}>
            {itOutSource?.data?.map((value: ItOutSourceItem, index: number) => (
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="absolute top-0.5 right-0.5 transition-all duration-300 ease-in-out group-hover:left-0">
                        ...
                        >
                          <g filter="url(#filter0_d_1_873_slider)">
                            <rect
                              x="3"
                              y="2"
                              width="52"
                          ...
                          <defs>
                            ...
                            >
                              ...
                              <feBlend
                                ...
                                result="effect1_dropShadow_1_873_slider"
                              />
                              <feBlend
                                mode="normal"
                                in="SourceGraphic"
                                in2="effect1_dropShadow_1_873_slider"
                                result="shape"
                              />
                            </filter>
                          </defs>
