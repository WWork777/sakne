                    ...
                    <div className="flex flex-col gap-14 xl:gap-24">
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            <div className="flex items-center py-3 gap-4 md:gap-8 w-full max-w-xl">
                                ...
                                <p className="section-bedge py-1.5 px-4 rounded-full">Команда мечты</p>
                            </div>
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    <h2 className="max-w-3xl">Наша Dream team</h2>
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">Анти-шаблонный подход: дизайн — от эскиза до пикселя, код — без конструкторов. Создаем цифровые продукты как арт-объекты.</p>
                                </div>
                            </div>
                        </div>
