              ...
              <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                ...
                <div className="flex flex-col gap-11">
                  <div className="flex flex-col gap-5 ">
                    <h2 className="max-w-3xl">Часто задаваемые вопросы</h2>
                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                      У вас наверняка есть сомнения: «Что такое Next.js?», «Чем
                      он лучше конструкторов?», «Сколько стоит поддержка?», «Как
                      быстро вы сделаете мой сайт?» Мы собрали 8 главных
                      вопросов, которые задают 9 из 10 клиентов — с честными и
                      короткими ответами
                    </p>
                  </div>
                </div>
