      ...
      <div className="container">
        <div className="flex flex-col 2xl:flex-row gap-10 2xl:gap-28">
          <div className="flex flex-col gap-5 2xl:gap-7 w-full 2xl:max-w-2xl 2xl:w-full">
            ...
            <div className="flex flex-col gap-5 2xl:gap-7">
              ...
              <p className="2xl:max-w-sm text-secondary/70 dark:text-white/70">
                Мы соединяем креатив, стратегию и технологии, создавая
                по-настоящему прорывные digital-решения. Инновационный подход,
                безупречное внимание к деталям — ваш цифровой прорыв
              </p>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-5 2xl:gap-7">
            <div className="relative bg-primary p-4 2xl:p-7 flex flex-col justify-between gap-8 md:gap-0">
              <div className="relative z-10 flex flex-col gap-2 lg:gap-4">
                ...
                <p className="dark:text-secondary">
                  Профессионально. Оперативно. Пунктуально
                </p>
              </div>
              <div className="relative z-10">
                <div className="relative border-b border-secondary/12 pb-5">
                  ...
                  <p className="text-base text-secondary/70">
                    Ни одного потерянного клиента — наш главный результат
                  </p>
                </div>
                <div className="flex items-center gap-2 lg:gap-5 pt-5">
                  <Image
                    src={"/images/home/aboutusIndex/arhitek.png"}
                    alt="Image"
                    width={64}
                    height={64}
                  />
                  <div>
                    ...
                    <p className="text-base text-secondary/70">Архитек</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-5 2xl:gap-7">
              <div className="w-full h-full about-us-fullimg">
                <Image
                  src={"/images/home/services/develop.webp"}
                  alt="Image"
                  width={340}
                  height={215}
            ...
            <div className="relative overflow-hidden p-5 2xl:p-7 border border-secondary/12 dark:border-white/30 flex flex-col justify-between gap-8 md:gap-0">
              ...
              <div className="flex flex-col gap-4 relative z-10">
                ...
                />
                <p>
                  Наш опыт работы с разными сферами помогает разрабатывать
                  дизайны, которые идеально соответствуют контексту и специфике
                  разных сфер бизнеса
                </p>
              </div>
